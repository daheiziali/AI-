...
export const indexDefinitions: IndexDefinition[] = [
  ...
  },
  {
    ...
    updatedAt: "2026年09月19日",
    updateSchedule: null,
    description: "追踪超大规模云服务商的 A100 按需租赁价格，用于观察成熟训练与推理算力的企业级云端成本。",
    sourceUrl: "https://www.silicondata.com/products/silicon-index",
    history: [
      { date: "2026-09-13", value: 3.7 },
      { date: "2026-09-14", value: 3.74 },
      { date: "2026-09-15", value: 3.78 },
      { date: "2026-09-16", value: 3.77 },
      { date: "2026-09-17", value: 3.76 },
  ...
  },
  {
    ...
    updatedAt: "2026年09月19日",
    updateSchedule: null,
    description: "追踪 AMD Instinct MI300X 的标准化每小时租赁价格，反映大显存 AI 加速算力的市场成本。",
    sourceUrl: "https://www.silicondata.com/products/silicon-index",
    history: [
      { date: "2026-09-13", value: 2.61 },
      { date: "2026-09-14", value: 2.62 },
      { date: "2026-09-15", value: 2.63 },
      { date: "2026-09-16", value: 2.64 },
      { date: "2026-09-17", value: 2.68 },
      { date: "2026-09-18", value: 2.66 },
  ...
  },
  {
    ...
    updatedAt: "2026年09月19日",
    updateSchedule: null,
    description: "追踪 NVIDIA H200 的标准化每小时租赁价格，反映高显存推理与训练算力的市场成本。",
    sourceUrl: "https://www.silicondata.com/products/silicon-index",
    history: [
      { date: "2026-09-13", value: 3.25 },
      { date: "2026-09-14", value: 3.27 },
      { date: "2026-09-15", value: 3.29 },
      { date: "2026-09-16", value: 3.34 },
      { date: "2026-09-17", value: 3.32 },
      { date: "2026-09-18", value: 3.31 },
      { date: "2026-09-19", value: 3.3 },
    ],
  },
  {
    slug: "gddr6-ram",
